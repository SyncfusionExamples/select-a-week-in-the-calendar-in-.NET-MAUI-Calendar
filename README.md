# How to select a week in the calendar in .NET MAUI Calendar (SfCalendar)
This repository contains a sample to select a week in the calendar in the [Syncfusion .NET MAUI Calendar](https://help.syncfusion.com/maui/calendar/getting-started) control.
